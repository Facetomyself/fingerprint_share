# Imperva-canadiannorth.com 采集模块

Imperva 风控（canadiannorth.com）的指纹采集模块。
...
| 页面 | 平台路由 |
|---|---|
| 条目详情 | `/e/imperva-canadiannorth.com` |
| 环境指纹采集 | `/collect/imperva-canadiannorth.com` |
| 行为指纹采集 | `/collect/imperva-canadiannorth.com/behavior` |
