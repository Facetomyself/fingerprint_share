# 通用-deep-fingerprint-v3 采集模块

通用 风控（deep-fingerprint-v3）的指纹采集模块。
...
| 页面 | 平台路由 |
|---|---|
| 条目详情 | `/e/generic-deep-v3` |
| 环境指纹采集 | `/collect/generic-deep-v3` |
| 行为指纹采集 | `/collect/generic-deep-v3/behavior` |
