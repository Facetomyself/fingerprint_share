# 瑞数6-electricity-ruishu-web-v2 插件（指纹采集模块包）

瑞数6 风控（electricity-ruishu-web-v2）的完整功能插件：采集脚本与展示页面一体化，
...
| 页面 | 平台路由 |
|---|---|
| 展示页 | `/e/ruishu-rs6-electricity` |
| 环境采集页 | `/collect/ruishu-rs6-electricity` |
| 行为剧本页 | `/collect/ruishu-rs6-electricity/behavior` |
