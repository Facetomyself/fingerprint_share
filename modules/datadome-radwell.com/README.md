# DataDome-radwell.com 采集模块

DataDome 风控（radwell.com）的指纹采集模块。
...
| 页面 | 平台路由 |
|---|---|
| 条目详情 | `/e/datadome-radwell.com` |
| 环境指纹采集 | `/collect/datadome-radwell.com` |
| 行为指纹采集 | `/collect/datadome-radwell.com/behavior` |
